    ...
    return [
        {
            ...
            "particle_count_error": tp - gt_count,
            "relative_particle_count_error": _safe_ratio(tp - gt_count, gt_count),
            ...
            "mean_relative_ecd_error": _safe_stat(relative_ecd_errors, np.mean),
        ...
        },
        {
            ...
            "particle_count_error": pred_count - tp,
            "relative_particle_count_error": _safe_ratio(pred_count - tp, pred_count),
            "mean_ecd_error": _safe_stat(ecd_errors, np.mean),
            "median_ecd_error": _safe_stat(ecd_errors, np.median),
            "mean_absolute_ecd_error": _safe_stat(np.abs(ecd_errors), np.mean),
            "median_absolute_ecd_error": _safe_stat(np.abs(ecd_errors), np.median),
